...
public:
    ...
    int main(int argc, char *argv[]) {
        ...
        iszdeex = binaryName.endsWith("zdeex") || binaryName.endsWith("zdeex.exe") || binaryName.endsWith("zdeex.app");
        qDebug() << "iszdeex=" << iszdeex;
        ...
        QCoreApplication::setApplicationName(iszdeex ? "SilentZdeeX" : "SilentDragon");
        ...
        w = new MainWindow();
        if(iszdeex) {
            w->setWindowTitle("SilentZdeeX v" + QString(APP_VERSION));
        } else {
